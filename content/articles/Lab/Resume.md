...
[ 4/21/2020 - Personal Comparison ](#4/21/2020)

<a name="overview"></a>
# Overview

I created my resume right after college using a LaTex template I found online.
I've been updating it since, but I'm finding it doesn't communicate
...
instead of web, so I want to focus on tools that are for the print medium. I would like to 
include some color, but technical resumes are often printed in black and white so I want to
make sure my resume still looks good in black and white.
...
much easier; instead of constantly redrawing or erasing. I don't have a drawing tablet(and 
...
that I need to at least try. They probably don't have a template that matches 
my design and I've found that word processors are very difficult to use for resumes unless 
their templates match what you want.
...
with the limitations of Google Docs. But the template is very visually appealing.
It is unlikely that my own resume designed by me will look quite as good, but
...
looking resume with minimal effort. Because of my layout needs I would like to look at other options. 
The next method I will try is Scribus.

<a name="Word Processor Update"></a>
### Word Processor Update

After reading Byfield's blog post on LibreOffice's effectiveness in desktop publishing I thought it 
would be good to look at Google Docs to see if they have similar features I didn't know about it. 
You can't insert text boxes, but you can insert drawings and put text in them.
After some googling and experimenting I couldn't find any good layout or alignment tools either. There are add-ons that
seem to add these features, but I don't think forcing Google Docs to do what I need is the best option.

<a name="4/8/2020"></a>
# 4/8/2020 - Scribus Tutorials

I've never used Scribus before so my first step will be investigating the tool and how
I might approach building a resume.

It was during this research that I discovered that LibreOffice might actually be a good fit.
I don't want to go into that tanget here, but after trying out Scribus I will look at LibreOffice.

I found some video tutorials for scribus [here](https://www.youtube.com/playlist?list=PLqazFFzUAPc6U1RcNRBMeCK6Hg3g_S6aN). 
I prefer video tutorials for GUI applications because I find them to be more clear than documentation or blogs. 
...
At first I though this post was just building a resume in Scribus, but it's actually very similar to what I'm
trying to do here. The author, Zack Grossbart, went through a similar desire to redo his resume after realizing
...
that InDesign(and Adobe's suite in general) is considered superior to the open source alernatives, but I expected
it to be sufficient for the rest of us. Grossbart has a similar engineering background(and open source preference)
like me, but he still felt InDesign was a better product. 

This is a very strong recomendation, but I think I will still use Scribus for this experiment. I dual boot Windows, 
...
is a not an area I had given serious thought to before, but it makes sense to do so. I plan on using his advice 
when constructing my own resume. 
...
since then and I know LibreOffice has(especially in terms of layout). It also seems that I'm not quite as 
experienced as a designer as Grossbart. Those two details may make Scribus and/or LibreOffice better fits for me.

Grossbart's blog also lead me to recognize two tangential details. First, the font of my own blog could be 
improved. Second, his blog is also somewhat of a project blog, just like what I intend for mine. So at some 
point I should revaluate the typography/font of my own blog. And I should revisit his blog as I develop 
mine.

<a name="4/10/2020"></a>
# 4/10/2020 - InDesign Blogs

I wanted to find more examples of blogs that go through this design process for resumes. Especially after 
...
where this concept came from. I hadn't watched the Styles tutorial in the video tutorials I watched because
...
Initially, I didn't feel that it was worth trying out word processors for building a resume. I tried out Google Docs
...
an entire book titled <ins>Designing With LibreOffice</ins>. He's interviewed about this book [here](http://designingwithlibreoffice.com/interview/). 
...
writing; so he is a professional when it comes to layout and publishing. He, like Grossbart, also mentioned 
the importance of typography when it comes to design. He mentioned the importance of styles in LibreOffice and
says they're incredibly critical to using LibreOffice well. He compares styles to variables in coding, which 
is personally, a helpful analogy. All of this would've been nice to know when using styles in Scribus.

Byfield even claims that LibreOffice Writer is better than Word as a Word Processor if used properly and considers
it a mid-level Desktop Publishing Software. He references that the control isn't as fine as Scribus, but more
than powerful enough for a lot of applications. He continues to assert that most people haven't realized that FOSS software isn't
...
and investigating this claim for myself.

<a name-"4/16/2020"></a>
# 4/16/2020 - Designing With LibreOffice

I was impressed with <ins>Designing with LibreOffice</ins>; it's really more of a book on design than 
...
options. Byfield is a big fan of using styles and templates but recognizes when they are unecssary. Even with the
limited scope of my resume, I still think it's appropriate to use styles here. One aspect of Latex that
appealed to me is focusing on formatting initially and then make minor adjustments to my resume over time. What
may change more frequently, is the content, which I can focus on with styles. 
But I don't make very many documents since leaving school. So I don't think I 
need to make a template here. If I continue to make more documents than I'll reconsider.

So I should start with using manual formatting to create a LibreOffice sample like my Scibus sample. Then I can
decide which application to settle on and go through Byfield's full desing process and create a style sheet.
...
But LibreOffice Writer didn't seem to have styles that could be applied to text frames. Every time I went into a
...
default frame was unattractive but I could easily create an ideal frame style for myself. To apply styles I would
...
This worked well enough but it doesn't show the styles in the navigator if they're in a frame. Again, this is 
a minor inconvenience, but I do now appreciate the story editor in Scribus. Having all the text content laid out
and being able to apply styles via a side bar feels like a great UI choice. Especially in complicated applications
where text spans multiple boxes. Writer's navigator can do this if I type like a word processor, but not with 
frames.

This is my sample document in LibreOffice. When desiging the layout, I found the 
alignment tool in LibreOffice isn't quite as good as I'd like. I can set anchors to certain objects(like frames),
but not other objects I've drawn. I also can't select both my line and frame and align that way(this is how Draw
does it). I seem to be able to come up with work arounds for my sample but it's something else to note.
...
ease of use and relied on manual formatting. However, my investigations with Scribus and LibreOffice have shown
that was just my ignorance. Desktop Publishing Software has plenty of features to allow for formatting and allow
me to focus on content; which is supposed to be the selling point of Latex. While it's still something I need to
learn, typesetting my desired layout in Latex will also take a considerable, indeterminate amount of time.
...
and typing and I can't use it in LibreOffice or Scibus. But I don't think this minor idiosyncracy is enough to
justify using Latex. So I will throw out Latex as option.

The other thing I've begun to realize is that Scribus's story editor is very similar to Latex, in which you focus
on content and annotate the content with styles. It annoyed me at first, but approaching it from a Latex 
perspective helps me appreciate it more.

<a name="4/21/2020"></a>
# 4/21/2020 - Personal Comparison 
Like I said before thought Latex was best

LibreOffice seemed better because I thought it was good enough for my purposes

But..., it looks like I need Scribus. Some of the issues I could overlook, but need for images forces Scribus

Might not make sense, but LibreOffice has value from a maintenance and skill building perspective. But
if tool isn't good enough, it won't matter

Will still use Byfield's book for design principles. Byfield also has a decent amount of Scribus articles 
I can look into
